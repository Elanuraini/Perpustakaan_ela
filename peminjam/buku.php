    ...
    <div class="container">
      ...
      <div class="container" style="margin-top: 3rem;">
        <div class="row">
          ...
          <h4 class="m-0 font-weight-bold text-white">Pilihan Buku</h4>
          <!-- Form pencarian -->
          ...
          ?>
            ...
            <div class="card" style="width: 15rem;">
              ...
              <div class="card-body">
                <h4 class="card-title"><a href="detail.php?id_buku=<?= $d['id_buku']; ?>"><?= $d['judul']; ?></a></h4>
                ...
                <div>
                  <a href="ulasan_buku_detail.php?id_buku=<?= $d['id_buku']; ?>" class="btn btn-warning text-dark">Ulasan</a>
                  <!-- pinjam buku -->
                  <?php
                  ...
                  ?>
                    <a href="" data-bs-toggle="modal" data-bs-target="#modalEditBuku<?= $d['id_buku']; ?>" class="btn btn-info text-dark">Pinjam</a>
                  <?php
                  }
                  ?>
                ...
                <form action="proses/tambah_pinjam.php" method="post">
                  <div class="modal-body">
                    <div class="form-group mt-2">
                      <input type="text" name="id_buku" id="id_buku" class="form-control" value="<?= $row['id_buku']; ?>" hidden>
                    </div>
                    <div class="form-group mt-2">
                      <input type="text" name="id_user" id="id_user" class="form-control" placeholder="Masukkan Nama id_user Buku" value="<?= $_SESSION['username']; ?>" hidden>
                    </div>
                    <div class="form-group mt-2">
                      <input type="date" name="tanggal_peminjaman" id="tanggal_peminjaman" class="form-control" hidden>
                    </div>

                    <div class="form-group mt-2">
                      <input type="text" name="tanggal_pengembalian" id="tanggal_pengembalian" class="form-control" hidden>
                    </div>
                    <div class="form-group mt-2">
